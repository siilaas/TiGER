...
function create_config( )
  ...
  config = {
    ...
    vip_users = {}, --vip users
    sudo_users = {1119481,2048790,676473,tonumber(108363478)},--Sudo users
    support_gp = {},--Support id
    moderation = {data = 'data/adv.json'},
    about_text = [[*IN THE NAME OF ALLAH*
This is an original bot and based on (Source, version 4 final).
Copyright all right reserved and you must respect all laws.

Source: https://github.com/siilaas/TIGERSource
Channel:
Messenger:
Creator: @oralius
Site: http://lua.org
